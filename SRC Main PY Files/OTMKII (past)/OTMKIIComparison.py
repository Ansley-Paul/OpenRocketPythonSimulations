...
ORK_FILE = r"E:/Monte Carlo Method/dependencies/ORK files/OTMKII (past)/UpdatedRocket.ork"
BASE_ENG_FILE = r"C:/Users/ansle/AppData/Roaming/OpenRocket/ThrustCurves/Pro98-6G-N1975GR.eng"
RESULTS_FILE = "OTMKII_results_68.csv"
ENG_OUTPUT_DIR = "generated_engines"
MOTOR_NAME = "Pro98-6G-N1975GR"
...
def extract_nominal_parameters(helper, doc):
    ...
    gross_weight = (
    # Nose Cone
    rocket.getChild(0).getChild(0).getMass() +
    rocket.getChild(0).getChild(0).getChild(0).getMass() +  # External Camera
    # Nosecone Coupler
    rocket.getChild(0).getChild(1).getMass() +
    rocket.getChild(0).getChild(1).getChild(0).getMass() +
    rocket.getChild(0).getChild(1).getChild(0).getChild(0).getMass() +  # Payload Bay Lid + U-Bolt + Nuts + 3x Quick Link + Swivel
    rocket.getChild(0).getChild(1).getChild(0).getChild(1).getMass() +  # Payload + Payload Sled + 4x Threaded Rods + 28x Nuts + Payload Mount Ring
    rocket.getChild(0).getChild(1).getChild(0).getChild(2).getMass() +
    # Forward Body Tube
    rocket.getChild(0).getChild(2).getMass() +
    rocket.getChild(0).getChild(2).getChild(0).getMass() +  # Main Parachute
    rocket.getChild(0).getChild(2).getChild(1).getMass() +  # Shock Cord + Chute Protector
    # Switchband (no children, assume direct mass)
    #rocket.getChild(0).getChild(3).getMass(0) +
    # Avionics Bay - Coupler Tube
    rocket.getChild(0).getChild(3).getMass() +
    rocket.getChild(0).getChild(3).getChild(0).getMass() +
    rocket.getChild(0).getChild(3).getChild(0).getChild(0).getMass() +  # Avionics Bay Lid + Nuts + Terminal Block + Cylinders + U-Bolt + Quick Link + Camera
    rocket.getChild(0).getChild(3).getChild(0).getChild(1).getMass() +  # Avionics Bay + Nuts + Terminal Block + Cylinders + U-Bolt + Quick Link
    rocket.getChild(0).getChild(3).getChild(0).getChild(2).getMass() +  # Avionics + Batteries + Mounting Hardware + 4x Threaded Rods + 4x Switches
    # Aft Body Tube
    rocket.getChild(0).getChild(4).getMass() +
    rocket.getChild(0).getChild(4).getChild(0).getMass() +  # Fins (4)
    rocket.getChild(0).getChild(4).getChild(1).getMass() +  # Motor Mount Tube
    rocket.getChild(0).getChild(4).getChild(2).getMass() +  # Thrust Puck
    rocket.getChild(0).getChild(4).getChild(3).getMass() +  # Drogue Parachute
    rocket.getChild(0).getChild(4).getChild(4).getMass() +  # Epoxy Mass
    rocket.getChild(0).getChild(4).getChild(5).getMass() +  # Centering Ring - Front
    rocket.getChild(0).getChild(4).getChild(6).getMass() +  # Centering Ring - Fins
    rocket.getChild(0).getChild(4).getChild(7).getMass() +  # Shock Cord + Chute Protector + 2x Quick Link + Swivel
    rocket.getChild(0).getChild(4).getChild(8).getMass() +  # Motor Retainer + Screws
    rocket.getChild(0).getChild(4).getChild(9).getMass() +  # Eyebolt + Nut + 2x Quick Link + Swivel
    rocket.getChild(0).getChild(4).getChild(10).getMass() +  # 15/15 Brass Rail Button
    rocket.getChild(0).getChild(4).getChild(11).getMass()   # Paint
...
def run_simulation(helper, rocket_file, run_num, writer, nominal_params):
    try:
        ...
        for component in rocket.getChild(0).getChild(4).getChild(2):
